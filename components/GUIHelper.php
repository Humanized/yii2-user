...
class GUIHelper {
    ...
    {
        return'<span style="margin-right:10px;color:' . ($inactive == FALSE ? 'green' : 'red') . '" class="glyphicon glyphicon-' . ($inactive == FALSE ? 'ok' : 'remove') . '"></span>' . ($inactive == FALSE ? ' Active' : ' Inactive');
    }
